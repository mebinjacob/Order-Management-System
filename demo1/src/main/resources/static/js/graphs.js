 ...
 */
      ...
      function storeSalesHistogramChart() {
    	  
    	  $.get("/storeManager/getSalesReportData", function(dataFromServer){

    		  var data = new google.visualization.DataTable();
    		  alert('The data is  ' + dataFromServer);
    		  data.addRows(dataFromServer);
    		  var options = {
    		            title: 'Sales Manager Report!!',
    		            legend: { position: 'none' },
    		          };
    		   var chart = new google.visualization.Histogram(document.getElementById('salesReport_div'));
    	        chart.draw(data, options);
    	  });
          /*var data = google.visualization.arrayToDataTable([
            ['Dinosaur', 'Length'],
